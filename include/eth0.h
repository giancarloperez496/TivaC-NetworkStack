...
extern const uint8_t EMPTY_MAC_ADDRESS[HW_ADD_LENGTH];
extern const uint8_t BROADCAST_MAC_ADDRESS[HW_ADD_LENGTH];
...
void copyMacAddress(uint8_t dest[6], const uint8_t src[6]);
